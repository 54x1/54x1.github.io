...
$(document).ready(function () {
    ...
    $(this, '.grid-container').scroll(function () {
        if ($(this, document, '.grid-container').scrollTop() > 2800 && oncedone1 == false) {
            ...
            if ($(this, document, '.grid-container').scrollTop() > 4200 && oncedone2 == false) {
                oncedone1 = true;
                $("#home-page-best-anime, .home-page-best-anime").fadeIn(2500);
                $("#home-page-best-anime, .home-page-best-anime").css({ "display": "grid" });
                oncedone2 = true;
            }
            if ($(this, document, '.grid-container').scrollTop() > 5285 && oncedone3 == false) {
